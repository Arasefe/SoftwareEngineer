...
public class MetricConverter {
    /*
     ...
     1 inch = 2.54cm  and one foot = 12 inches use the link I give you to confirm your code is calculating correctly.
    ...
    public static double calcFeetAndInchesToCentimeters(double feet, double inches){
        if(feet>0&&inches>=0||inches<=12){
            ...
            System.out.println(feet+" foot and "+inches+" inches is equal to " + centimeters + " centimeters ");
            return centimeters;
        }
        System.out.println("Invalid foot or inches input");
        return -1;
    }
